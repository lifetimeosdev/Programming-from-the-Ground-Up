#PURPOSE - Given a number, this program compute the
#factorial.For example,the factorial of 3 is 3*2*1,or 6.
...
factorial:
pushl %ebp       #standard function staff- we have to restore %ebp
	 	 #to its prior state before returnings, so we have
		 #to push it
...
cmpl $1, %eax      #If the number is 1,this is our base
